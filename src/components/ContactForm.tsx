...
export default function ContactForm({
  ...
  const labelClass = isPill
    ...
    : "text-sm font-medium";
  const noteClass = isPill ? "text-white/60" : "text-black/40";
  const inputClass = isPill
  ...
  return (
    ...
    >
      ...
      <div className="sm:col-span-2">
        ...
        {submitted && (
          <p className={`mt-3 text-sm ${isPill ? "text-white/80" : "text-black/60"}`}>
